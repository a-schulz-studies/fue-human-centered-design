...
#tablem[
  ...
  | ------------- | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
  | *1*         | *Personalisierung* der Anwendung anhand der individuellen Situation der Studierdenen                        | Alle Austauschstudenten                            |
  | *1*         | *Statusindikator* ob es in der aktuellen Situation zeitlich möglich ist, das Semester pünktlich zu starten  | Alle Austauschstudenten                            |
  ...
  | *1*         | *Notfallkontakte* wie Polizei, Krankenwagen und Botschaften.                                                | Alle Austauschstudenten                            |
  | *1*         | *Erasmus-spezifische Informationen* zu Programmen und Schritten.                                            | Erasmus-Studenten                                  |
  | *1*         | *Informationen zum Visumprozess* mit allen wichtigen Dokumenten                                             | Nicht EU Austauschstudenten                        |
  | *1*         | *Informationen zur Krankenversicherung*, mit Vergleich gesetzlicher und privater Optionen.                  | Nicht EU Austauschstudenten                        |
  | *1*         | *Rechner zum Konvertieren von ECTs* um zu prüfen, ob die Anforderungen an den Universitäten erfüllt werden. | Nicht EU Austauschstudenten                        |
  | *1*         | *Informationen zum Sperrkonto*                                                                              | Nicht EU Austauschstudenten                        |
  | *2*         | *Informationen zu Kultur und Orientierung* bspw. Funktionsweise ÖPNV, Unterschiede der Kultur.              | Alle Austauschstudenten                            |
  | *2*         | *Integration von studentischen Hilfsorganisationen* mit Kontaktdaten und Angeboten.                         | Alle Austauschstudenten                            |
  | *2*         | *Seriöse Links zu Wohnungsportalen* zur sicheren Unterkunftssuche.                                          | Alle Austauschstudenten                            |
  | *3*         | *Dokumentenübersetzung* für behördliche Kommunikation.                                                      | Alle Austauschstudenten                            |
  | *3*         | *Feedback-Funktion und Analytiks* für Verbesserungsvorschläge und Problemberichte zu den jeweiligen Prozessen (kontinuierliche Verbesserung). Die Erfassung realer Nutzungsdaten ermöglicht eine Optimierung der administrativen Abläufe durch bessere Ressourcennutzung.           | Alle Austauschstudenten                            |
  | *3*         | *Kostenrechner* zur Planung von Semestergebühren, Miete, Versicherungen und anderen Ausgaben.               | Finanzbewusste Studenten                           |
  | *3*         | *Anpassung des Unterstützungsgrads* damit Studierende mit unterschiedlichem Vorwissen individuell zugeschnittene Hilfestellungen erhalten. | Alle Austauschstudenten                            |
  | *3*         | *Terminbuchungsfunktion* für Behörden wie Einwohnermeldeamt und Ausländerbehörde.                           | Alle Austauschstudenten                            |
  | *3*         | *Vernetzungsfunktionen*, wie Foren oder Chatgruppen für Austauschstudenten.                                 | Kommunikationsfreudige Studenten                   |
  | *4*         | *Integration von Behörden-APIs*, um Antragsstatus und Bearbeitungszeiten abzurufen.                         | Alle Austauschstudenten                            |
  | *5*         | *Informationen zu Karriere und Teilzeitjobs* inklusive Unterstützung bei der Arbeitserlaubnis.              | Studenten, die arbeiten möchten oder Geld brauchen |
  | *5*         | *Reduzierung von Papierkram* durch digitale Dokumenteneinreichung und Verwaltung.                           | Alle Austauschstudenten                            |
]
